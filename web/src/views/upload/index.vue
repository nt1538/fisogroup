...
const CATALOG = {
  life: {
    ...
    products: [
      ...
      { carrier:'LSW - National Life', name:'PeakLife (1mm minimum face amount)', type:'IUL', product_rate:100 },
      { carrier:'LSW - National Life', name:'Summit Life (1mm minimum face amount)', type:'IUL', product_rate:100 },
