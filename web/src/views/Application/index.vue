          ...
          <table class="commission-table">
            <thead>
              <tr>
                ...
                <th>Product</th><th>Application Date</th><th>Policy #</th><th>Insured Name</th><th>Face Amount</th>
                <th>Target Premium</th><th>Planned Premium</th><th>Commission from Carrier</th>
            ...
            <tbody>
              <tr v-for="item in lifeOrders" :key="item.id">
                ...
                <td>{{ formatDate(item.application_date) }}</td><td>{{ item.policy_number }}</td><td>{{ item.insured_name }}</td>
          ...
          <table class="commission-table">
            <thead>
              <tr>
                <th>User ID</th><th>Name</th><th>National Producer Number</th>
                <th>Level</th><th>Commission Percentage</th><th>Commission Amount</th><th>Carrier</th>
                <th>Product</th><th>Application Date</th><th>Policy #</th><th>Insured Name</th><th>Initial Premium</th><th>Flex Premium</th><th>Commission from Carrier</th>
